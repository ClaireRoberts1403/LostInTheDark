...
const upleft = document.querySelector("#upleft");/**upleft arrow*/
const upright = document.querySelector("#upright");/**upright arrow*/
...
function four() {
  ...
  noise = true;
  upleft.style.backgroundColor = "darkSlateBlue";
}
/**upright arrow*/
function five() {
  if (noise) {
  ...
  noise = true;
  upright.style.backgroundColor = "darkSlateBlue";
}
/**left arrow*/
function two() {
  if (noise) {
...
function clearColor() {
  ...
  upright.style.backgroundColor = "transparent";
